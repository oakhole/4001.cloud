        ...
        function(e, t) {
                ...
                if (B && !r) {
                    ...
                    if (S.qsa && (!P || !P.test(e))) {
                        if (f = c = I, p = t, d = 9 === s && e, 1 === s && "object" !== t.nodeName.toLowerCase()) {
                            for (l = g(e), (c = t.getAttribute("id")) ? f = c.replace(Ee, "\\$&") : t.setAttribute("id", f), f = "[id='" + f + "'] ", u = l.length; u--;) l[u] = f + m(l[u]);
            ...
            function g(e, t) {
                ...
                for (s = e, u = [], l = j.preFilter; s;) {
                    (!r || (i = ge.exec(s))) && (i && (s = s.slice(i[0].length) || s), u.push(o = [])), r = !1, (i = me.exec(s)) && (r = i.shift(), o.push({
                        value: r,
                        type: i[0].replace(he, " ")
                    }), s = s.slice(r.length));
                    for (a in j.filter) !(i = Te[a].exec(s)) || l[a] && !(i = l[a](i)) || (r = i.shift(), o.push({
                        value: r,
                        type: a,
                        matches: i
                    }), s = s.slice(r.length));
            ...
            function x(e, t, n, r, i, a) {
                return r && !r[I] && (r = x(r)), i && !i[I] && (i = x(i, a)), o(function(o, a, s, u) {
                    var l, c, f, p = [],
                        ...
                        y = n ? i || (o ? e : h || r) ? [] : a : m;
                    if (n && n(m, y, s, u), r)
                        for (l = b(y, d), r(l, [], s, u), c = l.length; c--;)(f = l[c]) && (y[d[c]] = !(m[d[c]] = f));
                    if (o) {
                        if (i || e) {
                            if (i) {
            ...
            function N(e, t, n, r) {
                ...
                if (!r && 1 === l.length) {
                    ...
                    for (i = Te.needsContext.test(e) ? 0 : o.length; i-- && (a = o[i], !j.relative[s = a.type]);)
                        if ((u = j.find[s]) && (r = u(a.matches[0].replace(Se, Ae), ye.test(o[0].type) && t.parentNode || t))) {
            ...
            var E, S, A, j, D, L, H, q, _, M, O, F, B, P, R, W, $, I = "sizzle" + -new Date,
                ...
                le = "(?:\\\\.|[\\w-]|[^\\x00-\\xa0])+",
                fe = le.replace("w", "w#"),
                pe = "\\[" + ue + "*(" + le + ")" + ue + "*(?:([*^$|!~]?=)" + ue + "*(?:(['\"])((?:\\\\.|[^\\\\])*?)\\3|(" + fe + ")|)|)" + ue + "*\\]",
                de = ":(" + le + ")(?:\\(((['\"])((?:\\\\.|[^\\\\])*?)\\3|((?:\\\\.|[^\\\\()[\\]]|" + pe.replace(3, 8) + ")*)|.*)\\)|)",
                he = RegExp("^" + ue + "+|((?:^|[^\\\\])(?:\\\\.)*)" + ue + "+$", "g"),
                ge = RegExp("^" + ue + "*," + ue + "*"),
                me = RegExp("^" + ue + "*([>+~]|" + ue + ")" + ue + "*"),
                ye = RegExp(ue + "*[+~]"),
                ...
                Te = {
                    ...
                    ATTR: RegExp("^" + pe),
                    PSEUDO: RegExp("^" + de),
                    CHILD: RegExp("^:(only|first|last|nth|nth-last)-(child|of-type)(?:\\(" + ue + "*(even|odd|(([+-]|)(\\d*)n|)" + ue + "*(?:([+-]|)" + ue + "*(\\d+)|))" + ue + "*\\)|)", "i"),
                    bool: RegExp("^(?:" + se + ")$", "i"),
                    needsContext: RegExp("^" + ue + "*[>+~]|:(even|odd|eq|gt|lt|nth|first|last)(?:\\(" + ue + "*((?:-\\d)?\\d*)" + ue + "*\\)|)(?=[^-]|$)", "i")
                },
                we = /^[^{]+\{\s*\[native \w/,
                Ce = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/,
            ...
            L = n.isXML = function(e) {
                ...
                return n !== O && 9 === n.nodeType && n.documentElement ? (O = n, F = n.documentElement, B = !L(n), i && i.frameElement && i.attachEvent("onbeforeunload", function() {
                    ...
                    return e.innerHTML = "<a href='#'></a>", s("type|href|height|width", l, "#" === e.firstChild.getAttribute("href")), s(se, u, null == e.getAttribute("disabled")), e.className = "i", !e.getAttribute("className")
                    ...
                    e.innerHTML = "<select><option selected=''></option></select>", e.querySelectorAll("[selected]").length || P.push("\\[" + ue + "*(?:value|" + se + ")"), e.querySelectorAll(":checked").length || P.push(":checked")
                }), a(function(e) {
                    var t = n.createElement("input");
                    t.setAttribute("type", "hidden"), e.appendChild(t).setAttribute("t", ""), e.querySelectorAll("[t^='']").length && P.push("[*^$]=" + ue + "*(?:''|\"\")"), e.querySelectorAll(":enabled").length || P.push(":enabled", ":disabled"), e.querySelectorAll("*,:x"), P.push(",.*:")
                ...
                filter: {
                    ...
                    CLASS: function(e) {
                        var t = V[e + " "];
                        return t || (t = RegExp("(^|" + ue + ")" + e + "(" + ue + "|$)")) && V(e, function(e) {
    ...
    ce.fn.extend({
        ...
        toggleClass: function(e, t) {
            ...
            return ce.isFunction(e) ? this.each(function(n) {
                ...
                if ("string" === n)
                    for (var i, o = 0, a = ce(this), s = t, u = e.match(pe) || []; i = u[o++];) s = r ? s : !a.hasClass(i), a[s ? "addClass" : "removeClass"](i);
