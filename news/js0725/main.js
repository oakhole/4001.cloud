...
function init_case(pageSize, pageNum) {
	$.ajax({
		...
		success: function(e) {
			...
			document.querySelector('.caselist .cc .ss').style.animation =  Math.floor(i/4)*10+'s rowup linear infinite normal',
			document.querySelector('.caselist .cc .ss').style.webkitAnimation =  Math.floor(i/4)*10+'s rowup linear infinite normal',
